...
def arm_segments(arm1_length, arm2_length, theta1, theta2):
    ...
    arm1pos = PointE2(math.cos(theta1) * arm1_length, math.sin(theta1) * arm1_length)
    # These are dummy arms to fix: 
    arm1 = SegmentE2(PointE2(0, 0), arm1pos)
    t2 = theta1 + theta2
    arm2 = SegmentE2(arm1pos, PointE2(arm1pos.x + math.cos(t2) * arm2_length, arm1pos.y + math.sin(t2) * arm2_length))
