...
def pinning_rows(i):
    global vertices
    # Returns two rows of the rigidity matrix for pinning vertex i
    row_x = [(0,0) for _ in vertices]
    row_y = [(0,0) for _ in vertices]
    
    # Set the x and y coordinates of vertex i to (1,0) and (0,1) 
    row_x[i] = (1,0)
    row_y[i] = (0,1)
...
def print_degrees_of_freedom(R):
    # Prints the degrees of freedom of the mechanism
    print(R)
    ns = null_space(R)
