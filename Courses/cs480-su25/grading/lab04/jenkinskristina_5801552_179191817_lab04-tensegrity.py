...
redStyle = makeStyle(stroke=(255, 0, 0), fill=(
    255, 255, 255), strokeWeight=2.0)
blueStyle = makeStyle(stroke=(0, 0, 255), fill=(
    255, 255, 255), strokeWeight=2.0)
...
# tensegrity_scene.addAll([SegmentE3(vertices[i], vertices[j])
#                         for i, j in edges])
